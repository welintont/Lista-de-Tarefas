...
// Tarefa está recebendo os dados do localStorage do navegador
let tarefas = JSON.parse(localStorage.getItem('tarefas')) || [];

function renderizarTarefas(){

    // Limpar listagem de itens antes de renderizar novamente a tela
    lista.innerHTML = '';
    ...
    for(tarefa of tarefas){
        ...
        // Adicionar eventos no item da lista
...
btn.onclick = function(){
    ...
    if(novaTarefa !== ""){
        ...
        // Limpar o input depois de cadastrar nova tarefa
        input.value = '';
